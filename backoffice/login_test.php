            ...
            <div class="main-content d-flex flex-column p-0">
                <div class="m-auto login-shell">
                    <div class="login-card row g-0 align-items-stretch">
                        <div class="col-lg-6 d-none d-lg-block login-hero" style="position: relative; overflow: hidden;">
                            <img src="template/assets/images/login.jpg" alt="" aria-hidden="true" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover;">
                        </div>
                        <div class="col-lg-6">
                            <div class="login-form-wrap">
                                <div class="login-brand">
                                    <img src="template/assets/images/logo-icons.png" alt="CPDTH" onerror="this.style.display='none'">
                                    <!-- <img src="template/assets/images/logo.svg" alt="CPDTH" onerror="this.style.display='none'"> -->
                                    <div>
