        ...
        <div class="px-2">
            <div class="card app-card bg-white border-0 rounded-3 mb-4">
                <div class="card-header bg-white d-flex justify-content-between align-items-center flex-wrap gap-3 p-4">
                    ...
                    <a href="admin_fromadd.php" style="display: inline-flex; align-items: center; gap: 5px;" class="btn btn-primary">
                        <span class="material-symbols-outlined" aria-hidden="true" style="font-size: 20px;">add</span>เพิ่มผู้ดูแลระบบใหม่
                    </a>
                </div>
...
<script>
    ...
    function GetEditAdmin(user_id) {
        window.location.href = "admin_edit.php?key=" + user_id;
    }
